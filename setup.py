...
setup(name='radar-robotcar-dataset-sdk',
      ...
      data_files=[('radar_robotcar_dataset_sdk/downloader',
                  ...
                  ('radar_robotcar_dataset_sdk/downloader/rclone',
                   ['radar_robotcar_dataset_sdk/downloader/rclone/install.sh',
                    'radar_robotcar_dataset_sdk/downloader/rclone/COPYING'])],
